...
namespace Lacey.Medusa.Common.Auth.OAuth2.Base.OAuth2.Requests
{
    ...
    public class AuthorizationRequestUrl
    {
        ...
        /// </summary>
        [Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterAttribute("response_type", Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterType.Query)]
        public string ResponseType { get; set; }

        /// <summary>Gets or sets the client identifier.</summary>
        [Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterAttribute("client_id", Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterType.Query)]
        ...
        /// </summary>
        [Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterAttribute("redirect_uri", Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterType.Query)]
        ...
        /// </summary>
        [Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterAttribute("scope", Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterType.Query)]
        ...
        /// </summary>
        [Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterAttribute("state", Lacey.Medusa.Common.Api.Core.Base.Util.RequestParameterType.Query)]
