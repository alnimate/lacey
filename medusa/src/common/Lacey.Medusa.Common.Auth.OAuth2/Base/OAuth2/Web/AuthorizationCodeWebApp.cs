...
using Lacey.Medusa.Common.Auth.OAuth2.Base.OAuth2.Flows;
using Lacey.Medusa.Common.Auth.OAuth2.Base.OAuth2.Requests;
using Lacey.Medusa.Common.Auth.OAuth2.Base.OAuth2.Responses;

namespace Lacey.Medusa.Common.Auth.OAuth2.Base.OAuth2.Web
{
    /// <summary>
    ...
    public class AuthorizationCodeWebApp
    {
        ...
        public class AuthResult
        {
            ...
            /// <c>null</c> in case the <see cref="UserCredential"/> was loaded from the data 
            /// store.
            /// </summary>
