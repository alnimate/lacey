...
namespace Lacey.Medusa.Youtube.Api
{
  ...
  public class CaptionsResource
  {
    ...
    public class DownloadRequest : YouTubeBaseServiceRequest<string>
    {
      ...
      /// <para>Warning: This method hides download errors; use <see cref="M:Lacey.Medusa.Youtube.Api.CaptionsResource.DownloadRequest.DownloadWithStatus(System.IO.Stream)" /> instead.</para>
      /// </summary>
