...
namespace Lacey.Medusa.Youtube.Api.Base
{
  ...
  public class LiveBroadcastContentDetails : IDirectResponseSchema
  {
    ...
    /// <summary><seealso cref="T:System.DateTime" /> representation of <see cref="P:Lacey.Medusa.Youtube.Api.Base.LiveBroadcastContentDetails.BoundStreamLastUpdateTimeMsRaw" />.</summary>
    [JsonIgnore]
