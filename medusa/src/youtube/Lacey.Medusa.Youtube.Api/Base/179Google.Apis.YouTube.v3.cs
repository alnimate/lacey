...
{
  internal class LiveChatMessageListResponse : IDirectResponseSchema
  {
    ...
    /// <summary><seealso cref="T:System.DateTime" /> representation of <see cref="P:Lacey.Medusa.Youtube.Api.Base.LiveChatMessageListResponse.OfflineAtRaw" />.</summary>
    [JsonIgnore]
